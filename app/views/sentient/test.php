...
<body class="container">
    <div class="jumbotron">
        ...
        <button class="btn btn-primary" type="button">
            QNo: <span class="badge"><?php echo $question_no . "/" . $question_total ?></span>
        </button>
        <br><br>
        <form class="form-inline" action="" method="post">
            <div class="input-group pad-bottom">
                <span class="input-group-addon" id="basic-addon2">Question</span>
                <textarea class="form-control" rows="1" id="comment" style="margin: 0px; height: 100px; width: 520px; text-align: center;" disabled><?php echo $question; ?></textarea>
            </div>
            <br><br>
            <div class="input-group answer">
              ...
              <textarea class="form-control" rows="5" style="margin: 0px; height: 100px; width: 260px; text-align: center;" id="comment" disabled><?php echo $answer1; ?></textarea>
            </div>
            <div class="input-group answer">
              <span class="input-group-addon">
                <input type="radio" name="answer" value="2" id="answer2" aria-label="Option1">
              </span>
              <textarea class="form-control" rows="5" style="margin: 0px; height: 100px; width: 260px; text-align: center;" id="comment" disabled><?php echo $answer2; ?></textarea>
            </div>
            <div class="input-group answer">
              <span class="input-group-addon">
                <input type="radio" name="answer" value="3" id="answer3" aria-label="Option1">
              </span>
              <textarea class="form-control" rows="5" style="margin: 0px; height: 100px; width: 260px; text-align: center;" id="comment" disabled><?php echo $answer3; ?></textarea>
            </div>
            <div class="input-group answer">
              <span class="input-group-addon">
                <input type="radio" name="answer" value="4" id="answer4" aria-label="Option1">
              </span>
              <textarea class="form-control" rows="5" style="margin: 0px; height: 100px; width: 260px; text-align: center;" id="comment" disabled><?php echo $answer4; ?></textarea>
            </div>
            <br><br>
